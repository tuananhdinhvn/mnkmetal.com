!(function (e, t) {
    ...
    function b(e) {
        ...
        return (
            n ||
                ((n = x(e, t)),
                ("none" !== n && n) || ((We = (We || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement)), (t = We[0].contentDocument), t.write(), t.close(), (n = x(e, t)), We.detach()),
                ($e[e] = n)),
            n
        );
    }
    function w(e, t, n) {
        ...
        return (
            ...
            n &&
                ...
                Be.test(s) && Ie.test(t) && ((r = a.width), (i = a.minWidth), (o = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = r), (a.minWidth = i), (a.maxWidth = o))),
            void 0 !== s ? s + "" : s
        );
    }
    function T(e, t) {
    ...
    function k(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2)
            "margin" === n && (s += Z.css(e, n + Te[o], !0, i)),
                r
                    ? ("content" === n && (s -= Z.css(e, "padding" + Te[o], !0, i)), "margin" !== n && (s -= Z.css(e, "border" + Te[o] + "Width", !0, i)))
                    : ((s += Z.css(e, "padding" + Te[o], !0, i)), "padding" !== n && (s += Z.css(e, "border" + Te[o] + "Width", !0, i)));
        return s;
    }
    function E(e, t, n) {
        var r = !0,
        ...
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++)
            (r = e[s]),
                r.style &&
                    ...
                    (n = r.style.display),
                    t
                        ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && Ce(r) && (o[s] = me.access(r, "olddisplay", b(r.nodeName))))
                        : ((i = Ce(r)), ("none" === n && i) || me.set(r, "olddisplay", i ? n : Z.css(r, "display"))));
            ...
            for (
                ...
                if ((n = T.relative[e[a].type])) c = [d(h(c), n)];
                    ...
                    if (((n = T.filter[e[a].type].apply(null, e[a].matches)), n[W])) {
                        ...
                        return m(a > 1 && h(c), a > 1 && p(e.slice(0, a - 1).concat({ value: " " === e[a - 2].type ? "*" : "" })).replace(ue, "$1"), n, r > a && y(e.slice(a, r)), i > r && y((e = e.slice(r))), i > r && p(e));
                    }
                    c.push(n);
                }
            return h(c);
            ...
            (L = t.setDocument = function (e) {
                ...
                return r !== q && 9 === r.nodeType && r.documentElement
                    ? ((q = r),
                      ...
                      (w.matchesSelector = me.test((R = H.matches || H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector))) &&
                          i(function (e) {
                ...
                preFilter: {
                    ...
                    PSEUDO: function (e) {
                        ...
                        return he.CHILD.test(e[0])
                            ? null
                            : (e[3] ? (e[2] = e[4] || e[5] || "") : n && pe.test(n) && (t = k(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
                    },
                },
                filter: {
                    TAG: function (e) {
                            ...
                            : function (t, n, u) {
                                  ...
                                  if (v) {
                                      ...
                                      if (((h = [s ? v.firstChild : v.lastChild]), s && y)) {
                                          for (c = v[W] || (v[W] = {}), l = c[e] || [], d = l[0] === I && l[1], p = l[0] === I && l[2], f = d && v.childNodes[d]; (f = (++d && f && f[g]) || (p = d = 0) || h.pop()); )
                                              if (1 === f.nodeType && ++p && f === t) {
                                                  c[e] = [I, d, p];
                                                  break;
                                              }
                                      } else if (y && (l = (t[W] || (t[W] = {}))[e]) && l[0] === I) p = l[1];
                                      else for (; (f = (++d && f && f[g]) || (p = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== m : 1 !== f.nodeType) || !++p || (y && ((f[W] || (f[W] = {}))[e] = [I, p]), f !== t)); );
        ...
        return (
            ...
            (k = t.tokenize = function (e, n) {
                ...
                for (a = e, u = [], l = T.preFilter; a; ) {
                    (!r || (i = le.exec(a))) && (i && (a = a.slice(i[0].length) || a), u.push((o = []))), (r = !1), (i = ce.exec(a)) && ((r = i.shift()), o.push({ value: r, type: i[0].replace(ue, " ") }), (a = a.slice(r.length)));
            ...
            if (v && (u = v.events)) {
                for (t = (t || "").match(de) || [""], l = t.length; l--; )
                    if (((a = je.exec(t[l]) || []), (d = g = a[1]), (h = (a[2] || "").split(".").sort()), d)) {
                        ...
                        s && !p.length && ((f.teardown && f.teardown.call(e, h, v.handle) !== !1) || Z.removeEvent(e, d, v.handle), delete u[d]);
    ...
    (Me.optgroup = Me.option),
        ...
        Z.extend({
            clone: function (e, t, n) {
                ...
                if (t)
                    if (n) for (o = o || m(e), s = s || m(a), r = 0, i = o.length; i > r; r++) v(o[r], s[r]);
                    else v(e, a);
            ...
            buildFragment: function (e, t, n, r) {
                ...
                for (c.textContent = "", p = 0; (i = f[p++]); )
                    if ((!r || -1 === Z.inArray(i, r)) && ((u = Z.contains(i.ownerDocument, i)), (o = m(c.appendChild(i), "script")), u && g(o), n)) for (l = 0; (i = o[l++]); ) Fe.test(i.type || "") && n.push(i);
                return c;
            },
        ...
        Z.fn.extend({
            ...
            remove: function (e, t) {
                for (var n, r = e ? Z.filter(e, this) : this, i = 0; null != (n = r[i]); i++)
                    t || 1 !== n.nodeType || Z.cleanData(m(n)), n.parentNode && (t && Z.contains(n.ownerDocument, n) && g(m(n, "script")), n.parentNode.removeChild(n));
                return this;
            },
            empty: function () {
            ...
            domManip: function (e, t) {
                ...
                if (l && ((n = Z.buildFragment(e, this[0].ownerDocument, !1, this)), (r = n.firstChild), 1 === n.childNodes.length && (n = r), r)) {
                    for (i = Z.map(m(n, "script"), d), o = i.length; l > u; u++) (s = n), u !== f && ((s = Z.clone(s, !0, !0)), o && Z.merge(i, m(s, "script"))), t.call(this[u], s, u);
                    if (o)
                        for (a = i[i.length - 1].ownerDocument, Z.map(i, h), u = 0; o > u; u++)
                            (s = i[u]), Fe.test(s.type || "") && !me.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Re, "")));
                }
                return this;
            },
        }),
                ...
                return (
                    ...
                    void 0 === n
                        ? s && "get" in s && void 0 !== (i = s.get(e, !1, r))
                            ...
                            : u[t]
                        : ((o = typeof n),
                          "string" === o && (i = Ue.exec(n)) && ((n = (i[1] + 1) * i[2] + parseFloat(Z.css(e, t))), (o = "number")),
                          void (
                              null != n &&
                              n === n &&
            ...
            attr: function (e, t, n) {
                ...
                return e && 3 !== o && 8 !== o && 2 !== o
                    ? typeof e.getAttribute === ke
                        ? Z.prop(e, t, n)
                        : ((1 === o && Z.isXMLDoc(e)) || ((t = t.toLowerCase()), (r = Z.attrHooks[t] || (Z.expr.match.bool.test(t) ? it : rt))),
                          void 0 === n
    ...
    Z.fn.extend({
        val: function (e) {
            ...
            return arguments.length
                ...
                : i
                ? ((t = Z.valHooks[i.type] || Z.valHooks[i.nodeName.toLowerCase()]), t && "get" in t && void 0 !== (n = t.get(i, "value")) ? n : ((n = i.value), "string" == typeof n ? n.replace(ut, "") : null == n ? "" : n))
                : void 0;
        },
    }),
        Z.extend({
    ...
    Z.extend({
        ...
        ajax: function (e, t) {
                ...
                2 !== x &&
                    ...
                    u
                        ? (f.ifModified && ((b = w.getResponseHeader("Last-Modified")), b && (Z.lastModified[i] = b), (b = w.getResponseHeader("etag")), b && (Z.etag[i] = b)),
                          204 === e || "HEAD" === f.type ? (T = "nocontent") : 304 === e ? (T = "notmodified") : ((T = y.state), (c = y.data), (m = y.error), (u = !m)))
            ...
            if (
                ...
                (w.success = w.done),
                (w.error = w.fail),
                (f.url = ((e || f.url || wt) + "").replace(ft, "").replace(vt, Tt[1] + "//")),
                (f.type = t.method || t.type || f.method || f.type),
                (f.dataTypes = Z.trim(f.dataType || "*")
                    .toLowerCase()
                    .match(de) || [""]),
                null == f.crossDomain && ((u = mt.exec(f.url.toLowerCase())), (f.crossDomain = !(!u || (u[1] === Tt[1] && u[2] === Tt[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (Tt[3] || ("http:" === Tt[1] ? "80" : "443")))))),
    ...
    (Z.offset = {
        ...
        Z.fn.extend({
            offset: function (e) {
                ...
                return o
                    ? ((t = o.documentElement),
                      Z.contains(t, r) ? (typeof r.getBoundingClientRect !== ke && (i = r.getBoundingClientRect()), (n = I(o)), { top: i.top + n.pageYOffset - t.clientTop, left: i.left + n.pageXOffset - t.clientLeft }) : i)
                    : void 0;
            },
            position: function () {
                if (this[0]) {
