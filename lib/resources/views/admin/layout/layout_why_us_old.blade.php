                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($profile_doc_list as $item)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            {{-- <a class="get-edit-technology-btn" href="{{ asset('admin/template/whyus/profile/edit/'.$item->event_id) }}"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a> --}}
