                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active vilang">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="procat_ten" class="form-control" value="{{ old('procat_ten') }}"> 
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane enlang">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="procat_ten_en" class="form-control" value="{{ old('procat_ten_en') }}"> 
                                    </div>
                                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-panel" style="margin:0">
                        ...
                        <div class="form-group hidden">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="procat_author" class="form-control" value="{{ Auth::user()->name }}">
                            </div>
                        </div>
                            ...
                            <div class="col-md-10">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: auto;">
                                        <img src="{{ asset('public/noimage.jpg') }}" id="homepage_logo_output" style="width:100%; height:100%" alt="" />
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-3">
                                <select id="procat-child" class="alert alert-primary" name="procat_staff_id" style="width:200px; border: 1.5px solid #dbdbdb;">
                                    ...
                                    @foreach ($staff_list as $item)
                                        <option value="{{ $item->cust_id }}">{{ $item->cust_ten }}</option>
                                    @endforeach
                        ...
                        {{-- <div class="form-group">
                            ...
                            <div class="col-sm-1 col-md-1">
                                <input type="number" name="procat_prio" min="1" class="form-control" value="{{ old('procat_prio') }}"> 
                            </div>
                        </div> --}}
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10 col-sm-9">
                                    <input type="text" name="procat_title" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="procat_mota" id="" style="width:100%;" rows="7"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10 col-sm-9">
                                    <input type="text" name="procat_keyword" class="form-control">
                            </div>
                        </div>
