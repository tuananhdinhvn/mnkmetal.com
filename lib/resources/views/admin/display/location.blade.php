...
@section('title', 'Danh sách location') 
            ...
            <div class="col-md-12">
                ...
                <div class="content-panel">
                    ...
                    <div class="col-sm-2 col-sm-2 pull-right">
                            <a href="{{ asset('admin/project/location/add') }}">
                                <button class="pull-right btn btn-primary">Thêm location</button>
                            </a>
                    </div>
                    ...
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <thead>
                            <tr class="">
                                <th class="col-md-10 "><i class="fa fa-tag "></i> Tên location </th>
                        ...
                        <tbody>
                            ...
                            @foreach ($location_list as $item)
                                <tr>
                                    <td>
                                        <a href="{{ asset('admin/project/location/edit/'.$item->locate_id) }}">{{ $item->locate_name_vi }}</a>
                                    </td>
                                    
                                    <td style="text-align:center">
                                        <a href="{{ asset('admin/project/location/edit/'.$item->locate_id) }}">
                                            <button class="btn btn-primary btn-xs" title="Chỉnh sửa"><i class="fa fa-pencil"></i></button>
                                        </a>
                                        <a  rel="{{ $item->locate_id }}"
                                            proname="{{ $item->locate_name_vi }}"
                                            href="javascript:"
                                            title="Xóa dự án"
