        ...
        <section class="wrapper">
            ...
            <div class="col-lg-12 mt">
                <div class="row content-panel">
                    ...
                    <h4 class="mb">Thêm danh mục con</h4>
                    <br>
                    @include('error.note')
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active vilang">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" required name="procat2_ten" value="{{ old('procat2_ten') }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane enlang">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" required name="procat2_ten_en" value="{{ old('procat2_ten_en') }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-panel" style="margin:0">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10 col-sm-9">
                                        <input required type="text" name="procat2_title" class="form-control" value="{{ old('procat2_title') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea required name="procat2_description" id="" style="width:100%;" rows="7">{{ old('procat2_description') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required name="procat2_keyword" value="{{ old('procat2_keyword') }}" class="form-control">
                                </div>
                            </div>
