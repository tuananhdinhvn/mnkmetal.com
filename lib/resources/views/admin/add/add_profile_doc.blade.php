...
<section id="main-content">
    ...
    <section class="wrapper">
        ...
        <div class="row content-panel">
            <h2 class="centered">Thêm profile</h2>
            <div class="col-md-12 mt mb">
                ...
                <form method="post" enctype='multipart/form-data'>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Tên tài liệu<br>(Tiếng Hàn): </label>
                        <div class="col-sm-10">
                            <input type="text" required name="event_ten_kr" class="form-control">
                        </div>
                    </div>
