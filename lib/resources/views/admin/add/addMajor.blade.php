...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        <div class="row content-panel">
            <h2 class="centered">Thêm ngành nghề</h2>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            <div class="form-group" style="margin-bottom: 30px;">
                                                ...
                                                <div class="col-sm-10">
                                                    <input required type="text" name="major_name_vi" class="form-control" value="">
                                                </div>
                                            </div><br/>
                                            ...
                                            <div class="form-group" style="margin-bottom: 30px;">
                                                ...
                                                <div class="col-sm-10">
                                                    <input required type="text" name="major_name_en" class="form-control" value="">
                                                </div>
                                            </div><br/>
                                            ...
                                            <div class="form-group" style="margin-bottom: 30px;">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="major_name_zh" class="form-control" value="">
                                                </div>
                                            </div><br/>
                                            ...
                                            <div class="form-group" style="margin-bottom: 30px;">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="major_name_ja" class="form-control" value="">
                                                </div>
                                            </div><br/>
                                            ...
                                            <div class="form-group" style="margin-bottom: 60px;">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="major_name_kr" class="form-control" value="">
                                                </div>
                                            </div>
                                            <br/>
                                        </div>
