                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10 col-sm-9">
                                <select class="alert alert-primary" name="phanquyen" style="width:200px; border: 1.5px solid #dbdbdb;">
                                        ...
                                        <option value="2" @if ( $user_item->phanquyen==2 ) selected @endif>Editor</option>
                                        {{-- <option value="3" @if ( $user_item->phanquyen==3 ) selected @endif>Guest</option> --}}
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <select class="alert alert-primary" required name="project_share_1" style="width:100%; border: 1.5px solid #dbdbdb;">
                                        ...
                                        @foreach ($project_list as $item)
                                            <option value="{{ $item->pro_id }}" @if ( $user_item->project_share_1==$item->pro_id ) selected @endif>{{ $item->pro_ten_en }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                    <select class="alert alert-primary" required name="project_share_2" style="width:100%; border: 1.5px solid #dbdbdb;">
                                        <option value="0">Chọn dự án</option>
                                        @foreach ($project_list as $item)
                                            <option value="{{ $item->pro_id }}" @if ( $user_item->project_share_2==$item->pro_id ) selected @endif>{{ $item->pro_ten_en }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                    <select class="alert alert-primary" required name="project_share_3" style="width:100%; border: 1.5px solid #dbdbdb;">
                                        <option value="0">Chọn dự án</option>
                                        @foreach ($project_list as $item)
                                            <option value="{{ $item->pro_id }}" @if ( $user_item->project_share_3==$item->pro_id ) selected @endif>{{ $item->pro_ten_en }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                    <select class="alert alert-primary" required name="project_share_4" style="width:100%; border: 1.5px solid #dbdbdb;">
                                        <option value="0">Chọn dự án</option>
                                        @foreach ($project_list as $item)
                                            <option value="{{ $item->pro_id }}" @if ( $user_item->project_share_4==$item->pro_id ) selected @endif>{{ $item->pro_ten_en }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
