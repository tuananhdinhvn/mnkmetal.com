                ...
                <div style="padding: 20px 10px 0 10px;" class="form-panel">
                    ...
                    <form class="form-horizontal style-form" enctype='multipart/form-data' method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="blog_mota_vi" id="" style="width:100%;" rows="7">{{ $blog_edit->blog_mota_vi }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="blog_mota_en" id="" style="width:100%;" rows="7">{{ $blog_edit->blog_mota_en }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="blog_mota_zh" id="" style="width:100%;" rows="7">{{ $blog_edit->blog_mota_zh }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="blog_mota_ja" id="" style="width:100%;" rows="7">{{ $blog_edit->blog_mota_ja }}</textarea>
                            </div>
                        </div>
