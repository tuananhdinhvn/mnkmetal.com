        ...
        <section class="wrapper">
            ...
            <div class="col-lg-12 mt">
                <div class="row content-panel">
                    ...
                    <h3 class="mb mt">Thông tin sự kiện</h3>
                    <br>
                    @include('error.note')
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active vilang">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input required type="text" name="event_ten" class="form-control" value="{{ $event_item->event_ten }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="editmce" name="event_des" id="" style="width:100%;" rows="20">{{ $event_item->event_des }}</textarea>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane enlang">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input required class="form-control" type="text" name="event_ten_en" value="{{ $event_item->event_ten_en }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="editmce form-control" name="event_des_en" id="" style="width:100%;" rows="20">{{ $event_item->event_des_en }}</textarea>
                                    </div>
                                </div>
                ...
                <div class="col-lg-12">
                    <div class="form-panel" style="margin:0">
                        ...
                        <div class="form-group hidden">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="event_editor" class="form-control" value="{{ Auth::user()->name }}">
                            </div>
                        </div>
                            ...
                            <div class="col-md-10">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: auto;">
                                        <img src="{{ asset('public/upload/event/'.$event_item->event_thumb) }}" class="image_output" style="width:100%; height:100%" alt="" />
                                    </div>
                            ...
                            <div class="col-lg-10 col-sm-1">
                                ...
                                <div class="col-lg-4 col-sm-12" style="padding-left: 0">
                                    ...
                                    <select id="procat-main" required class="alert alert-primary" name="event_end_day" style="width: 100%; border: 1.5px solid #dbdbdb;">
                                        ...
                                        @for ($i =1; $i <= 31; $i++)
                                            <option value="{{ $i }}" @if ($event_item->event_end_day == $i) selected="selected" @endif>{{ $i }}</option>
                                        @endfor
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-4 col-sm-12" style="padding-left: 0">
                                    ...
                                    <select id="procat-main" required class="alert alert-primary" name="event_end_month" style="width: 100%; border: 1.5px solid #dbdbdb;">
                                        ...
                                        @foreach ($months as $item)
                                            <option value="{{ $item }}" @if ($event_item->event_end_month == $item) selected="selected" @endif>{{ $item }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-4 col-sm-12" style="padding-left: 0">
                                    ...
                                    <input required type="number" name="event_end_year" min="2000" value="{{ $event_item->event_end_year }}" style="width: 100%; border: 1.5px solid #dbdbdb; height: 55px; border-radius: 5px">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group bootstrap-timepicker">
                                    <input type="text" name="event_end_time" value="{{ $event_item->event_end_time }}" class="form-control timepicker-24">
                        ...
                        <div class="form-group">
                            <div class="row pull-right" style="padding-right:50px">
                                <input style="width:auto;" type="submit" class="btn btn-primary fileinput-upload fileinput-upload-button" value="Cập nhật sự kiện">
                                <a href="{{ asset('admin/event') }}"><input style="width:100px;" type="button" class="btn btn-danger" value="Hủy"></a>
                            </div>
                        </div>
                        {{ csrf_field() }}
                        {{-- </form> --}}
