            ...
            <div class="col-md-12">
                ...
                <div class="content-panel">
                    <div class="col-sm-2 col-sm-2 pull-right">
                            <a href="{{ asset('admin/'.$blog_type.'/add') }}?type={{ $blog_type }}">
                                <button class="pull-right btn btn-primary">Thêm bài viết</button>
                            </a>
                    </div>
                   
                    @if( $blog_type != 'about' && $blog_type != 'blog' )
                    <div>
                    ...
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ asset('admin/'.$blog->blog_type.'/edit/'.$blog->blog_id) }}?type={{ $blog->blog_type }}">{{ $blog->blog_ten_en }}</a>
                                </td>
                                <td style="text-align: center;">
                                    <a href="{{ asset('admin/blog/show/'.$blog->blog_id) }}?type={{ $blog->blog_type }}" >
                                ...
                                <td style="text-align: center">
                                    ...
                                    <a href="{{ asset('admin/'.$blog->blog_type.'/edit/'.$blog->blog_id) }}?type={{ $blog->blog_type }}">
