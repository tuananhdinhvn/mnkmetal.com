                ...
                <div class="form-panel">
                    ...
                    <form class="form-horizontal style-form" enctype='multipart/form-data' method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="qna_ques" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="qna_ques_en" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group hidden">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="qna_author" class="form-control" value="{{ Auth::user()->name }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="editmce" name="qna_ans" id="" style="width:100%;" rows="20"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="editmce" name="qna_ans_en" id="" style="width:100%;" rows="20"></textarea>
                            </div>
                        </div>
