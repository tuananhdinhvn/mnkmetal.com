                ...
                <div class="form-panel">
                    ...
                    <form class="form-horizontal style-form" enctype='multipart/form-data' method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="blogcat_ten_en" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group hidden">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="blogcat_author" class="form-control" value="{{ Auth::user()->name }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10 col-sm-9">
                                    <input type="text" name="blogcat_title" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="blogcat_mota" id="" style="width:100%;" rows="7"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10 col-sm-9">
                                    <input type="text" name="blogcat_keyword" class="form-control">
                            </div>
                        </div>
