                ...
                <div style="padding: 20px 10px 0 10px;" class="form-panel">
                    ...
                    <form class="form-horizontal style-form" enctype='multipart/form-data' method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="cust_ten" class="form-control" value=""> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="cust_diachi" class="form-control" value=""> 
                            </div>
                        </div>
                        ...
                        @if($people_type=='team')
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="cust_email" class="form-control" value=""> 
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="cust_phone" class="form-control" value=""> 
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="cust_zalo" class="form-control" value=""> 
                                </div>
                            </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="cust_ghichu" class="form-control" value=""> 
                                </div>
                            </div>
                        @endif
                        <!--End Type == team-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="cust_noidung" id="" style="width:100%;" rows="10"></textarea>
                            </div>
                        </div>
                        @endif
