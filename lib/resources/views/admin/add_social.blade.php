                ...
                <div style="padding: 20px 10px 0 10px;" class="form-panel">
                    ...
                    <form class="form-horizontal style-form" enctype='multipart/form-data' method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="editmce" name="img_description_vi" id="" style="width:100%;" rows="20"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="editmce" name="img_description_en" id="" style="width:100%;" rows="20"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="editmce" name="img_description_zh" id="" style="width:100%;" rows="20"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="editmce" name="img_description_ja" id="" style="width:100%;" rows="20"></textarea>
                            </div>
                        </div>
