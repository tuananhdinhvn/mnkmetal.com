                ...
                <div style="padding: 20px 10px 0 10px;" class="form-panel">
                    ...
                    <form class="form-horizontal style-form" enctype='multipart/form-data' method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="img_number" min="0" class="form-control" value="{{ $number_item->img_number }}"> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="img_description_vi" class="form-control" value="{{ $number_item->img_description_vi }}"> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="img_description_en" class="form-control" value="{{ $number_item->img_description_en }}"> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="img_description_zh" class="form-control" value="{{ $number_item->img_description_zh }}"> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="img_description_ja" class="form-control" value="{{ $number_item->img_description_ja }}"> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="img_description_kr" class="form-control" value="{{ $number_item->img_description_kr }}"> 
                            </div>
                        </div>
                            ...
                            <div class="col-md-10">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 225px; height: auto;">
                                        <img src="{{ asset('public/upload/image/'.$number_item->img_src) }}" class="image_output" style="width:100%; height:100%" alt="" />
                                    </div>
                        ...
                        <div class="form-group last">
                            ...
                            <div class="col-md-10">
                                <input type="checkbox" name="img_plus_icon" @if($number_item->img_plus_icon == 1) checked="checked" @endif/>
                            </div>
                        </div>
