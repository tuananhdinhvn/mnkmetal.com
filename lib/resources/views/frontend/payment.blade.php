                                        ...
                                        <div class="fieldset">
                                            ...
                                            <div class="field   ">
                                                <div class="field-input-wrapper">
                                                    ...
                                                    <input placeholder="Họ và tên" required class="field-input" size="30" type="text" id="" name="cust_hoten" value="" />
                                                </div>
                                            ...
                                            <div class="field  field-two-thirds  ">
                                                <div class="field-input-wrapper">
                                                    ...
                                                    <input placeholder="Email" required class="field-input" size="30" type="email" id="" name="cust_email" value="" />
                                                </div>
                                            ...
                                            <div class="field field-required field-third  ">
                                                <div class="field-input-wrapper">
                                                    ...
                                                    <input placeholder="Số điện thoại" required class="field-input" size="30" maxlength="11" type="tel" name="cust_phone" value="" />
                                                </div>
                                            ...
                                            <div class="field   ">
                                                <div class="field-input-wrapper">
                                                    ...
                                                    <input placeholder="Địa chỉ" required class="field-input" size="30" type="text" id="" name="cust_diachi" value="" />
                                                </div>
