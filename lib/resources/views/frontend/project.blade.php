            ...
            <section id="topWorks" class="g-py-80">
                <div id="intro-project" class="container-fluid text-center g-max-width-950">
                    <div class="text-uppercase g-brd-primary">
                        <h3 id="project-title" class="h3 g-letter-spacing-5 g-font-size-24 g-font-weight-400 g-color-primary" style="">@lang('messages.project_title')</h3>
                ...
                <div class="container-fluid px-0 project-list-cover">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div id="all-project-slide" class="owl-carousel owl-theme">
                            ...
                            @foreach ($project_list_all->chunk(8) as $chunk)
                                <div class="item row">
                                            ...
                                            <div class="project-list-item-inner" style="">
                                                ...
                                                <a href="{{ asset('project/'.$item->pro_id) }}">
                                                    @if($item->pro_thumb_hover != '')
                                                        <img class="img-fluid w-100 thumb-hover" src="{{ asset('public/upload/product/'.$item->pro_thumb_hover) }}" style="" />
                                                    @else
                                                        <img class="img-fluid w-100 thumb-hover" src="{{ asset('public/upload/product/'.$item->pro_thumb) }}" style="" />
                                                    @endif
                                                    
                                                    
                                                    <img class="img-fluid w-100 project-main-thumb" alt="" src="{{ asset('public/upload/product/'.$item->pro_thumb) }}" />
                                                </a>
